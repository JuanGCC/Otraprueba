...
public class Trabaja extends JFrame {
    ...
    public void Button()
    {
        ...
        botones.Botones(jButton,"Aceptar",new int[]{1085, 600, 150, 40},panel,"BajasBusquedaTrabaja",this);
    }
    public void Label()
    {
    ...
    public void Text()
    {
        ...
        Jtextfield jtextfield = new Jtextfield();
        jtextfield.TextField(jTextField,new int[]{905,470, 200, 40},panel,"BajaBusquedaTrabaja","Curp");
    }
    public void panel()
    {
        panel = new JPanel();
